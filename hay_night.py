...
class Cauliflower(pygame.sprite.Sprite):
    ...
    def plant(self):
        ...
        print(coords_of_cauliflower_beds)
        self.x_pos, self.y_pos = cur_x, cur_y
        p.blit()
